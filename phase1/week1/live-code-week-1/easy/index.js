function beliBoba(uangJajan) {
    ...
    const modalAwal = uangJajan;

    console.log(`Bella mulai jajan dengan uang jajan ${modalAwal} rupiah.`);

    listBoba.forEach((i) => {
        if (uangJajan >= i[1]) {
            console.log(`Dengan uang ${uangJajan}, cukup untuk beli '${i[0]}'`);
            console.log(`setelah beli '${i[0]}' uangnya berkurang ${i[1]}`);
            uangJajan -= i[1];
            console.log(`jadi uangnya sisa ${uangJajan}`);
        } else {
            console.log(`Dengan uang ${uangJajan}, tidak cukup untuk beli '${i[0]}'`);
        }
    });
    console.log(`Bella pulang dengan sisa uang jajan ${uangJajan}..`);
    console.log("=====");
